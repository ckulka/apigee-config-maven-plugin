 ...
 */
@Mojo(name = "exportAppKeys", defaultPhase = LifecyclePhase.INSTALL)
public class ExportKeysMojo extends GatewayAbstractMojo {
  private static Logger logger = LoggerFactory.getLogger(ExportKeysMojo.class);
  ...
  private static class ApiProducts {
    @Key
  ...
  private void doExport(Map<String, List<String>> apps)
      throws MojoFailureException {
  ...
  private static void exportToFile(ServerProfile profile, List<App> apps, String exportFilePath) {
  ...
  private static List<String> getApp(ServerProfile profile, String developerId)
  ...
  private static App getAppDetails(ServerProfile profile, String developerId, String app)
      throws IOException, MojoFailureException {
